...
export default function TechIcon({ name, size = 17 }: { name: string; size?: number }) {
  const icon = icons[iconNames[name]];
  if (name === "LinkedIn") {
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24" width={size} height={size} fill="currentColor" className="brand-icon">
